...
key3`,
        ...
        'CLIEngine': '命令行引擎(注意！只有选择本地环境或者docker沙箱时，Agent Skills才能正常使用)',
        'workspace': '工作区',
        ...
        'defaultPermissionMode': '默认仅启用只读工具集',
        'acceptEdits': '启用文件编辑和文件系统操作',
        'bypassPermissions': '启用所有权限',
        'permissionMode': '权限模式',
        'planMode': '仅启用只读工具集且生成计划',
        ...
        'DockerSandboxNotice1': 'Docker沙箱模式下，你需要安装docker，并使用`docker pull docker/sandbox-templates:latest`拉取最新的沙箱模板镜像',
        'localEnvironmentNotice1': '本地环境下，请不要给AI过多权限，以免造成系统损坏，如果你希望AI能在更安全的环境下运行，可以选择Docker沙箱模式',
...
Key3`,
        ...
        'CLIEngine': 'Command Line Engine (Note! Agent Skills can only be used normally when the local environment or Docker sandbox is selected).',
        'workspace': 'Workspace',
        ...
        'defaultPermissionMode': 'Default read-only toolset only',
        'acceptEdits': 'Enable file editing and file system operations',
        'bypassPermissions': 'Enable all permissions',
        'permissionMode': 'Permission mode',
        'planMode': 'Read-only toolset only and generate plan',
        ...
        'DockerSandboxNotice1': 'In Docker sandbox mode, you need to install Docker and use `docker pull docker/sandbox-templates:latest` to pull the latest sandbox template image',
        'localEnvironmentNotice1': 'In a local environment, please do not grant excessive permissions to the AI to avoid system damage. If you wish to run the AI in a safer environment, you can choose the Docker sandbox mode.',
