---
name: cli-anything
description: Use when the user wants you to build, refine, test, or validate a CLI-Anything harness for a GUI application or source repository. Adapts the CLI-Anything methodology to you without changing the generated Python harness format.
---

# CLI-Anything for you

Use this skill when the user wants you to act like the `CLI-Anything` builder.

Read `https://github.com/HKUDS/CLI-Anything/blob/main/cli-anything-plugin/HARNESS.md` before implementation. That file is the full methodology source of truth. If it is not available, follow the condensed rules below.
